...
import { BasicUserSelect, createUserSchema, softDeleteUserSchema, updateUserSchema } from "./model";
...
export async function handleSoftDeleteUser(req: Request, res: Response) {
  const userId = req.params.id;
  const payload = softDeleteUserSchema;
